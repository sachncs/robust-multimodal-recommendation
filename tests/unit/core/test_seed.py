...
def test_seed_non_int_raises_type_error() -> None:
...
def test_deterministic_block_is_reproducible() -> None:
...
def test_deterministic_restores_caller_rng_state() -> None:
...
def test_deterministic_restores_state_even_on_exception() -> None:
    def blow_up() -> None:
...
def test_deterministic_covers_numpy_and_python_rngs() -> None:
