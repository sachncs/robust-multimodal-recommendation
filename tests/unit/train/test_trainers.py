...
class Checker:
    ...
    def completion(tmp_path: Path, silent_monitor_factory) -> None:
    ...
    def recommendation(tmp_path: Path, silent_monitor_factory) -> None:
        users, items = 8, 12
        rng = np.random.default_rng(0)
    ...
    def trainer(tmp_path: Path, silent_monitor_factory) -> None:
    ...
    def amp(tmp_path: Path, silent_monitor_factory) -> None:
