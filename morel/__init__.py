...
LAZY_EXPORTS = {
    ...
    "device": "morel.core.device",
    "DistributedState": "morel.core.distributed",
    "rank": "morel.core.distributed",
    "world_size": "morel.core.distributed",
    "init": "morel.core.distributed",
    "cleanup": "morel.core.distributed",
    "reduce_mean": "morel.core.distributed",
    "is_rank_zero": "morel.core.distributed",
    "barrier": "morel.core.distributed",
    "local_rank": "morel.core.distributed",
    "state": "morel.core.distributed",
